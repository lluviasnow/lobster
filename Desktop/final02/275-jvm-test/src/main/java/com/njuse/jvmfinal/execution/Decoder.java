...
import com.njuse.jvmfinal.instructions.references.GETSTSTIC;
...
//        opMap.put(OpCode.ARETURN, new ARETURN());
 //       opMap.put(RETURN_, new RETURN());
        opMap.put(OpCode.GETSTATIC, new GETSTSTIC());
